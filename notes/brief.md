...
::: {.table-block}
<div class="table-cap">How many well-placed clinics would put 90% of people within a 15-minute walk of one clinic. “They cover” applies the same rule to clinics already on the map.</div>
...
::: {.table-block}
<div class="table-cap">Share of people within a 15-minute walk of a clinic, and of a school, timed separately. Five nearby places, 5 km/h.</div>
...
<img src="../charts/pipeline.png" alt="Flowchart from inventories through walking times to scores and maps" />
</figure>
